...
## Fase 4: Campos VTEX Padrão Completos
- [x] Adicionar campos SKU: EAN, altura real, largura real, comprimento real, peso real
- [x] Adicionar campos de referência: código referência SKU, código fabricante, código referência produto
- [x] Adicionar campos de controle: ativar SKU, SKU ativo, produto ativo, mostrar no site, mostrar sem estoque
- [x] Adicionar campos de data: data previsão chegada, data lançamento produto
- [x] Adicionar campos de relacionamento: acessórios, similares, sugestões, show together, anexos
- [x] Adicionar suporte a especificações customizadas (campo, tipo, valores)
- [x] Adicionar suporte a campos customizados por departamento/categoria
- [x] Atualizar prompt LLM para extrair todos os campos VTEX padrão
- [x] Criar tabela de especificações customizadas no banco de dados
- [x] Atualizar interface de detalhes para exibir especificações customizadas
