    ...
    scrape: publicProcedure.input((val: unknown) => {
      ...
      try {
        ...
        const result = await createProduct({
          userId: ctx.user.id,
          sourceUrl: input.url,
          productName: sanitizeString(data.name),
          productDescription: sanitizeString(data.description),
          price: sanitizeString(data.price),
          originalPrice: sanitizeString(data.originalPrice),
          currency: sanitizeString(data.currency),
          skuCode: sanitizeString(data.sku),
          skuEan: sanitizeString(data.ean),
          categoryName: sanitizeString(data.category),
          brandName: sanitizeString(data.brand),
          ...
          productMetaTitle: sanitizeString(data.metaTitle),
          productMetaDescription: sanitizeString(data.metaDescription),
          productKeywords: sanitizeString(data.metaKeywords),
          weight: sanitizeString(data.weight),
          height: sanitizeString(data.height),
          width: sanitizeString(data.width),
